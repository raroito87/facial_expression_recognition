...
if not __name__ == '__main_':
    ...
    t = time.time()
    trained_model , optimizer, criterion, loss_hist, loss_val_hist, last_model = train_classifier.run_train(n_epochs = n_epochs, lr=learning_rate, batch_size=batch_size)
