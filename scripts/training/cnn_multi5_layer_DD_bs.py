...
if not __name__ == '__main_':
    print('train cnn_multi5_layer_balanced_sampling_DD')
    ...
    pre.load_data(filename='DatasetDD.csv.gz', name='train')
    ...
    model_name = f'cnn_multi5_layer_DD_bs_{learning_rate}_{batch_size}_{n_epochs}_{n_classes}'
    ...
    if args.s_model:
        m_exporter = ModelExporter('fer2013_datasetDD', root_dir=current_working_dir)
