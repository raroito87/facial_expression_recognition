...
if not __name__ == '__main_':
    print('train cnn_multi5_layer_balanced_sampling_E')
    ...
    pre.load_data(filename='DatasetE.csv.gz', name='train')
    ...
    model_name = f'cnn_multi5_layer_E_bs_{learning_rate}_{batch_size}_{n_epochs}_{n_classes}'
    ...
    if args.s_model:
        m_exporter = ModelExporter('fer2013_datasetE', root_dir=current_working_dir)
